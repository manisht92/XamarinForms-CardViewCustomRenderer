...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinForms_CardViewCustomRenderer.Android.dll" comes first in this list. */
		"XamarinForms_CardViewCustomRenderer.Android.dll",
		"FormsViewGroup.dll",
		...
		"XamarinForms-CardViewCustomRenderer.dll",
	};
